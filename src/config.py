...
class Config:
    def __init__(self):
        ...
        self.memory_importance_weight = float(os.getenv("MEMORY_IMPORTANCE_WEIGHT", "0.3"))
        self.memory_recency_weight = float(os.getenv("MEMORY_RECENCY_WEIGHT", "0.2"))
        self.memory_recency_halflife_hours = float(os.getenv("MEMORY_RECENCY_HALFLIFE_HOURS", "24.0"))
